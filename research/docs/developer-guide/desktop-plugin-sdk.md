...
-   **`host.state.*`** — readonly views over the app's live state (nanostore atoms): active session, cwd, gateway status, model, profile, viewport.
