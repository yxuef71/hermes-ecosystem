...
web\_search + web\_extract only

Code work

`["terminal", "file"]`

Shell access + file operations
...
Parallel batch size per `delegate_task` call
...
How many delegation levels can spawn further
