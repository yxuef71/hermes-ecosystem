...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-ascii-art
...
Optional — install with `hermes skills install official/creative/ascii-art`

Path

`optional-skills/creative/ascii-art`
