...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-system-atlas
...
Optional — install with `hermes skills install official/creative/system-atlas`

Path

`optional-skills/creative/system-atlas`
...
Harshyt Goel (adapted by Nous Research)
...
`architecture`, `diagrams`, `isometric`, `documentation`

Related skills

[`architecture-diagram`](/docs/user-guide/skills/bundled/creative/creative-architecture-diagram), [`excalidraw`](/docs/user-guide/skills/optional/creative/creative-excalidraw)
...
Single source of truth: structures, flows, chapters, decisions, questions, prose

Yes

`atlas/template.html` + `atlas/build.mjs`
...
Built atlas; republish at the same URL after every rebuild
...
-   Click a structure and confirm the panel says **pinned** and offers _Go inside_; click a packet dot and confirm the payload opens.
