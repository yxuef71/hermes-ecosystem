...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-touchdesigner-mcp
...
Optional — install with `hermes skills install official/creative/touchdesigner-mcp`

Path

`optional-skills/creative/touchdesigner-mcp`
...
[`ascii-video`](/docs/user-guide/skills/bundled/creative/creative-ascii-video), [`manim-video`](/docs/user-guide/skills/bundled/creative/creative-manim-video)
