...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-sketch
...
Optional — install with `hermes skills install official/creative/sketch`

Path

`optional-skills/creative/sketch`
