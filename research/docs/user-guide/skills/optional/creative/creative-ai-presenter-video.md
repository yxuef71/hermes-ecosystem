...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-ai-presenter-video
...
Optional — install with `hermes skills install official/creative/ai-presenter-video`
...
cclank ([https://github.com/cclank/lanshu-create-ai-presenter-video](https://github.com/cclank/lanshu-create-ai-presenter-video)), ported by Hermes Agent
...
`video`, `presenter`, `avatar`, `lipsync`, `tts`, `captions`, `creative`

Related skills

[`hyperframes`](/docs/user-guide/skills/optional/creative/creative-hyperframes), [`kanban-video-orchestrator`](/docs/user-guide/skills/optional/creative/creative-kanban-video-orchestrator), [`comfyui`](/docs/user-guide/skills/optional/creative/creative-comfyui)
