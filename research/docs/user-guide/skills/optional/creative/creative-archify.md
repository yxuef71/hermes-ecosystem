...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-archify
...
Optional — install with `hermes skills install official/creative/archify`

Path

`optional-skills/creative/archify`
...
`diagram`, `architecture`, `workflow`, `sequence`, `dataflow`, `state-machine`, `mermaid`, `html`, `svg`

Related skills

[`architecture-diagram`](/docs/user-guide/skills/bundled/creative/creative-architecture-diagram), [`excalidraw`](/docs/user-guide/skills/optional/creative/creative-excalidraw), [`concept-diagrams`](/docs/user-guide/skills/optional/creative/creative-concept-diagrams)
...
Full documentation: [https://github.com/tt-a1i/archify#readme](https://github.com/tt-a1i/archify#readme)
