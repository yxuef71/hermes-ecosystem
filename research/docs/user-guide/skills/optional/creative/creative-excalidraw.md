...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/creative/creative-excalidraw
...
Optional — install with `hermes skills install official/creative/excalidraw`
