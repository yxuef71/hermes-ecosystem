...
Optional — install with `hermes skills install official/productivity/here-now`

Path

`optional-skills/productivity/here-now`
...
`here.now`, `herenow`, `publish`, `deploy`, `hosting`, `static-site`, `web`, `share`, `URL`, `drive`, `storage`
...
Full docs: [https://here.now/docs](https://here.now/docs)
