...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-evaluation-evaluating-llms-harness
...
Optional — install with `hermes skills install official/mlops/evaluating-llms-harness`

Path

`optional-skills/mlops/evaluation/evaluating-llms-harness`
