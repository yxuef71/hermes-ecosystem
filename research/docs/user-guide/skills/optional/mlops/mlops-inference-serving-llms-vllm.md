...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-inference-serving-llms-vllm
...
Optional — install with `hermes skills install official/mlops/serving-llms-vllm`

Path

`optional-skills/mlops/inference/serving-llms-vllm`
