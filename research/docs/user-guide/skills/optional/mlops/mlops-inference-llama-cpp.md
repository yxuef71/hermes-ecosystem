...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-inference-llama-cpp
...
Optional — install with `hermes skills install official/mlops/llama-cpp`

Path

`optional-skills/mlops/inference/llama-cpp`
