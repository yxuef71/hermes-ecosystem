...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/mlops/mlops-evaluation-weights-and-biases
...
Optional — install with `hermes skills install official/mlops/weights-and-biases`

Path

`optional-skills/mlops/evaluation/weights-and-biases`
