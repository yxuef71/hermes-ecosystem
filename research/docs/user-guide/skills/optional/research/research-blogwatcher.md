...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/research/research-blogwatcher
...
Optional — install with `hermes skills install official/research/blogwatcher`
