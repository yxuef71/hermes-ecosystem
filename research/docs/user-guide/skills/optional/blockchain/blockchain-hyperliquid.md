...
Optional — install with `hermes skills install official/blockchain/hyperliquid`
...
Hugo Sequier (Hugo-SEQUIER), Hermes Agent
...
`Hyperliquid`, `Blockchain`, `Crypto`, `Trading`, `Perpetuals`, `Spot`, `DeFi`
