...
**Source:** https://hermes-agent.nousresearch.com/docs/user-guide/skills/optional/web-development/web-development-publish-site
...
Optional — install with `hermes skills install official/web-development/publish-site`

Path

`optional-skills/web-development/publish-site`
...
`publish`, `deploy`, `hosting`, `github-pages`, `cloudflare-pages`, `netlify`, `static-site`, `versioning`, `rollback`, `web-development`
...
`git checkout <previous-tag> -- . && redeploy` (or provider dashboard)
