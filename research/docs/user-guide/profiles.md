...
**What counts as a channel setting** — the inventory is ownership-based and is judged in the _source_ profile's plugin scope (its private `plugins/` adapters included):
