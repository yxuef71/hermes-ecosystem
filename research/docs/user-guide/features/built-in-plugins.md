...
Close and reopen the session scope after a context compaction completes (at the next turn boundary, never mid-turn)

`max_turns`

`0`

Rotate after every N turns within a segment; `0` disables the cap
